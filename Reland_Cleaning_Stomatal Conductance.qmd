...
```{r}
StomCon_Winter <- read_excel("StomCon_Winter 2019 GH Relandscaping Stomatal Conductance Data.xlsx", 
             sheet = 1)
            # col_names = FALSE, 
             # col_names = TRUE,
             #col_types = TRUE, 
...
```{r}
StomCon_Fall <- read_excel("StomCon_Fall 2018 GH Relandscaping Stomatal Conductance Data.xlsx")
```
...
#### Issue #1: Calculate mean measurements
